      ...
      <div class="row p-0 m-0">
         <div class="col-12">
            <a href="index.php?content=furniture">
               <input class="button" type="submit" value="เฟอร์นิเจอร์">
            </a>
            <a href="index.php?content=location">
               <input class="button" type="submit" value="ที่ตั้ง">
            </a>
            <a href="index.php?content=types">
               <input class="button" type="submit" value="ประเภทอสังหาริมทรัพย์">
            </a>
         </div>
      </div>
                  ...
                  <div class="row">
                     <div class="col-lg-6">
                        ...
                        <input id="product_header_th" name="product_header_th"
                           value="<?PHP echo $product_header[0]['product_header_th'];?>" class="form-control" />

                        <textarea class="form-control " id="product_header_detail_th" name="product_header_detail_th"
                     ...
                     <div class="col-lg-6">
                        ...
                        <input id="product_header_en" name="product_header_en"
                           value="<?PHP echo $product_header[0]['product_header_en'];?>" class="form-control" />
                        <textarea class="form-control " id="product_header_detail_en" name="product_header_detail_en"
            ...
            <tr>
               ...
               <td>
                  <?PHP 
                    ...
                    ?>
                  <a href="?content=product&action=recommened&id=<?PHP echo $product[$i]['product_id'];?>&recommened=0">
                     <i class="fa fa-star" aria-hidden="true"></i>
                  </a>
                  <?PHP        
                    }else{
                    ?>
                  <a href="?content=product&action=recommened&id=<?PHP echo $product[$i]['product_id'];?>&recommened=1">
