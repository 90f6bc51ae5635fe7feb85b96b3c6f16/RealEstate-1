        ...
        <div class="row" style="max-width: 1100px;margin: auto;">
            <div class="element-item col-lg-6 col-md-6 col-sm-6 col-6 img-poppular-home-padding">
                <img class="img-poppular-home1"
                    src="img_upload/product_image/<?PHP  echo ($product_popula[0]['product_image_img']) ?>">
            </div>
            <div class="element-item col-lg-6 col-md-6 col-sm-6 col-6 img-poppular-home-padding">
                <img class="img-poppular-home1"
                    src="img_upload/product_image/<?PHP  echo ($product_popula[1]['product_image_img']) ?>">
            </div>
        </div>
        <div class="row" style="max-width: 1100px;margin: auto; padding-top: 1vw; padding-bottom: 1vw;">
            <div class="element-item col-lg-4 col-md-4 col-sm-4 col-4 img-poppular-home-padding">
                <img class="img-poppular-home2"
                    src="img_upload/product_image/<?PHP  echo ($product_popula[2]['product_image_img']) ?>">
            </div>
            <div class="element-item col-lg-4 col-md-4 col-sm-4 col-4 img-poppular-home-padding">
                <img class="img-poppular-home2"
                    src="img_upload/product_image/<?PHP  echo ($product_popula[3]['product_image_img']) ?>">
            </div>
            <div class="element-item col-lg-4 col-md-4 col-sm-4 col-4 img-poppular-home-padding">
                <img class="img-poppular-home3"
                    src="img_upload/product_image/<?PHP  echo ($product_popula[4]['product_image_img']) ?>">
            </div>
        </div>
    </fieldset>
</div>
