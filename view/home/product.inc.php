   ...
   <div class="text-center margin-product-home">
      ...
      <div class="responsive">
         ...
         <div class="" style="border: ridge;">
            <img class="size-img-product-home"
               src="img_upload/product_image/<?PHP echo $product[$i]['product_image_img'];?>" alt="">
            ...
            <div class="text-regular" style="padding: 16px 0px; color: #c6c6c6;">
               <a href="property.php?action=product&id=<?PHP echo $product[$i]['product_id']; ?>&type_id=<?PHP echo $product[$i]['product_types_id']; ?>"
                  class="btn btn-outline-success" tabindex="0">
                  <?PHP
if($lng == "TH"){
echo 'รายละเอียด';
}else{
