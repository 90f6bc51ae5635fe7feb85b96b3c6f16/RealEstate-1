						...
						<div class="col-lg-2">
							<div class="form-group" style="margin-top: 10px;margin-bottom: 10px;">
								<div style="text-align: center;">
									<img id="product_image" style="height: 200px;width: 340px;" src="../img_upload/product_image/<?php if($product_image[$i]['product_image_img'] != "") echo $product_image[$i]['product_image_img']; else echo "default.png" ?>" class="img-responsive img-size-sup"> 
